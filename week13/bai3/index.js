...
for (let product of products) {
  ...
  if (product.category === "men's clothing") menClothing.appendChild(item);
  if (product.category === "jewelery") jewelery.appendChild(item);
  if (product.category === "electronics") electronics.appendChild(item);
  if (product.category === "women's clothing") womenClothing.appendChild(item);
}
